...
auto BPlusTreePage::Few() const -> bool { return GetSize() < GetMinSize(); }
auto BPlusTreePage::SafeInsert() const -> bool { return GetSize() < GetMaxSize(); }
auto BPlusTreePage::SafeRemove() const -> bool { return GetSize() > GetMinSize(); }
